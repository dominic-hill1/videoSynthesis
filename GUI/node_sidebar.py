...
class Sidebar(QWidget):
    def __init__(self, editor, parent=None):
        ...
        self.button13 = QPushButton('Addition')        
        self.button14 = QPushButton('Multiplication')
        self.button15 = QPushButton('Division')
        self.button16 = QPushButton('Negation')
        ...
        self.button13.clicked.connect(lambda: self.editor.addNode(AddNode(self.editor.scene)))
        self.button14.clicked.connect(lambda: self.editor.addNode(MultiplyNode(self.editor.scene)))
        self.button15.clicked.connect(lambda: self.editor.addNode(DivideNode(self.editor.scene)))
        self.button16.clicked.connect(lambda: self.editor.addNode(NegateNode(self.editor.scene)))
